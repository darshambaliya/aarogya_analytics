...
class UEmeInfo(models.Model):
    e_id = models.AutoField(primary_key=True)
    u_id = models.CharField(max_length=15, blank=True, null=True)
    u_name = models.CharField(max_length=20)
    u_rel = models.CharField(max_length=15, blank=True, null=True)
...
class UHealthGenInfo(models.Model):
    u_id = models.IntegerField(blank=True, null=True)
    blood_pre = models.CharField(max_length=10, blank=True, null=True)
    diabetes = models.CharField(max_length=10, blank=True, null=True)
    bmi = models.IntegerField(blank=True, null=True)
    differently_abled = models.IntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'u_health_gen_info'
